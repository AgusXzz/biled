...
export const isUserJid = jid => isPnUser(jid) || isLidUser(jid)
export const isAnyHostedJid = jid => isHostedPnUser(jid) || isHostedLidUser(jid)
export const hostedJidToDomain = jid => (isHostedPnUser(jid) ? 's.whatsapp.net' : 'lid')
export const isOwnJid = (jid, meId, meLid) => areJidsSameUser(jid, meId) || (meLid && areJidsSameUser(jid, meLid))
